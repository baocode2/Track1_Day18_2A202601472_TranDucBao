...
|---|---|---|---|
| Bản chung ba option | Lê Quang Huy | A, B, C — chuyển qua lại bằng nút | [prototype/index.html](prototype/index.html) |
...
trên cùng một ngữ cảnh ở cả ba option. Ba file riêng thì mỗi lần chuyển option là đổi luôn
...
khi đã xong vòng so sánh ba option. Màn luyện tập trắc nghiệm của bản đó là thứ bản chung
không có.
...
Ba nút A / B / C ngay trên khung chat. Banner phía trên hiện tên option, người phụ trách,
...
- **Reset** — nút *Reset ngữ cảnh* xoá sạch state cả ba option và nhật ký, đưa về A. Dùng
  giữa hai tester.
...
- Chặng 3 đang nằm rải ba file ([bản chung](03-human-ai-design-pass.md),
  [bản của Cường](03-human-ai-design-damvietcuong.md), [bản của Bảo](chang3_C.md)) — cần gộp về một.
