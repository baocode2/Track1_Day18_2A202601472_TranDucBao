...
khi đã xong vòng so sánh bốn option. Màn luyện tập trắc nghiệm của bản đó là thứ bản chung
không có.
...
Cùng một ngữ cảnh cho cả bốn option, không đổi khi chuyển option:
...
| **D** | AI gửi một tin nói rõ **sẽ im cho đến khi được chỉ**, rồi khay ba mẩu bấm được. Chỉ một mẩu thì sinh **đúng một** lời giải kèm mẩu gốc | Chip chọn mẩu; khi đang mở lời giải thì có *Giải thích dễ hơn* và *Đóng, về ba mẩu* |
...
- **D** — lời giải nằm lại trong thread; bấm *Đóng, về ba mẩu* thì lời giải bị gỡ và khay ba
  mẩu hiện lại. D **không tạo ra artifact nào để giữ** — đóng xong là hết, và đó là thiết kế
...
- Chặng 3 đang nằm rải bốn file ([bản chung bốn cột](03-human-ai-design-pass.md),
