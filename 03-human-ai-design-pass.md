...
đúng **một khoảnh khắc** quyết định, và đó là chỗ ba option thật sự khác nhau:
...
Ngoài ba khoảnh khắc này, prototype không thêm màn hình nào cho từng tiêu chí.
...
**Feedback ảnh hưởng tới đâu.** Việc user duyệt hay loại thẻ ở Option B, và đổi mục tiêu ở
Option C, **chỉ có tác dụng trong phiên hiện tại**. Hệ thống không ghi nhớ sang lần sau và
...
- [x] **Mỗi option có ít nhất một đường kiểm soát hoặc phục hồi.** A: gỡ chip nguồn, sửa tự
      do. B: sửa / đổi / loại / hoàn tác. C: rollback một bấm về ghi chú gốc.
